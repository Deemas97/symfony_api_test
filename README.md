...
2. Запустить Composer для установки зависимостей проекта.
   
3. Запустить Makefile
    ! Рекомендуется отключить антивирус на время работы с проектом
    во избежание блокировок соединения с компонентами контейнера !
...
к Symfony-приложению базой данных (i)

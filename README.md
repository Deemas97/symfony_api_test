...
### Настройка подключения приложения Symfony к БД PostgresQL
...
> (i) Порядок тестов отсортирован от старого к новому. Тест IntegratedTest.php работает только с подключенной к Symfony-приложению базой данных
